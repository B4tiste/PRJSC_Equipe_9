...
public class ApproximerIncendie {
    ...
    /**
     * @param tab la liste des capteurs qui reprÃ©sente un incendie
     * @param size le nombre de capteur
     * @return les coordonÃ©e d'un probable incendie
     */
    ...
    /**
     *
     * @param pointRef le point de rÃ©fÃ©rence pour faire le calcul d'angle sur une liste de point (ABC) => (B)
     * @param myList la liste deux point Ã  calculer l'angle par rapport au point de ref et le 1er point de la liste
     * @return la liste des angle entre le 1er point de la liste, le point de reference et les autres
     * @brief Permet d'avoir un ensemble d'angle d'une liste de point par rapport Ã  un point de rÃ©fÃ©rence
     */
    ...
    /**
     * @param pointRef le point de rÃ©fÃ©rence pour effectuer le trie
     * @param myList la liste de point Ã  trier
     * @return la liste de point tirer sur un cercle trigonomÃ©trique autour du point de rÃ©ference (par rapport Ã  la droite entre le point de
     * rÃ©ference et le 1er point de la liste
     */
    ...
    /**
     * @param point les coordonnÃ©s d'un point
     * @param tab une liste de donnÃ©s de capteur
     * @return vrai si le point appartient Ã  tout les disque donnÃ©es par les capteurs
     */
