...
public class CalculGeneral {
    ...
    /**
     *
     * @param point1 les coordonn̩es du 1er point (A)
     * @param point2 les coordonn̩es du 2nd point (B)
     * @param point3 les coordonn̩es du 3̬me point (C)
     * @return l'angle entre les 3 point (ABC)
     * @brief permet de calculer l'angle (ABC) entre trois points avec leurs coodon̩es
     */
     ...
     * @return le point de gravit̩ du polygone
    ...
    /**
     * @param cercle1 un trouple repr̩sentant un cercle avec ses coordonn̩s et son rayon
     * @param cercle2 un trouple repr̩sentant un cercle avec ses coordonn̩s et son rayon
    ...
    /**
     * @param myList un eliste de point donn̩es par leurs coordonn̩es
